...
#### 使用说明
1.  双击运行支叶主程序"zhiye.exe"，输入密码“1234”，输入中文内容即可（可以直接定义运行功能，也可以通过C/C++程序注入功能：更多用法教程关注“支叶认知”（快手、斗音）。


#### C++库编引入说明
1.  通过loadlib内部函数加载，unload 释放（示例代码：自然语言理解NLU-第三方功能接入）
...
支叶mt版本是为了兼容更多windows系统：

[git克隆地址]: https://gitee.com/kebo521/nlu_mt.git
